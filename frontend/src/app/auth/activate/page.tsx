        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <>
              <div className="mb-6">
                <p className="text-sm text-gray-600">
                  Welcome{firstName ? `, ${firstName}` : ''}! Set your password to activate your account
                  {tenantName ? ` with ${tenantName}` : ''}.
                </p>
                {email && (
          ...
          {state === 'success' && (
            <div className="text-center py-6">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Your account has been activated successfully. You can now sign in with your email and the password you just set.
              </p>
              <Link
                href="/auth/login"
